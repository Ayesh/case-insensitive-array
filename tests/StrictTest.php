...
class StrictTest extends TestCase {
    ...
    public function testInitializationWithArray(): void {
        ...
        self::assertEquals(
            'Fred',
            $array['Baz'],
            'Array initialization with a source array, exact-key access success.'
        );
    ...
    public function testDebugInfo(): void {
        ...
        self::assertStringContainsString(
            'ThuNA',
            $dump,
            'Checking the var_dump return value to contain the overridden header.'
        );
    }
}
